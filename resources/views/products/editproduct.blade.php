                ...
                <div class="col-lg-12 mb-5 mb-lg-0">
                    ...
                    <div class="contact-form">
                        <form method="post" enctype="multipart/form-data" action="/storeproduct">
                            @csrf
                            <p>
                                 <input type="hidden" required style="width: 100%" placeholder="" name="id"
                            ...
                            <p style="display: flex;">
                                <input type="number" required class="mr-4" value="{{ $product->price }}"
                                    style="width: 50%" placeholder="Price" name="price" id="price">
                                <span class="text-danger">
                                    @error('price')
                                        {{ $message }}
                                    @enderror
                                </span>
                                <input type="number" required style="width: 50%" value="{{ $product->amount }}"
                            ...
                            <p>
                                <textarea name="description" required {{ $product->description }} id="description" cols="30" rows="10"
